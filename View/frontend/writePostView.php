...
<div class="container col-md-12">
  ...
  <div class="col-md-10 mx-auto m-5">
    <form method="post" action="index.php?action=writePost" data-aos="zoom-in">
      <a href="index.php?action=adminSpace"> <span class="return-icon" title="Rtourer à la page de tous les chapitres"><i id="btn-return" class="fas fa-undo animated"></i></span></a>
