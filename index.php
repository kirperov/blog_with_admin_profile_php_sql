...
$actions = array("listPosts", "listAllPosts", "editPagePosts","postEdit", "editPost", "post", "pageWriteChapiter", "writePost", "postDelete","addComment", "alertedcomments", "alertcomment", "commentEdit", "editComment", "commentDelete", "editPageUser", "editUser", "connexion", "connect", "logout", "adminSpace", "pageEditUser" , "pagination");
  ...
  //Renvoie vers la page de connexion
    ...
    // Gestion espace User
      ...
      if(isset($_SESSION['ticket']) && isset($_COOKIE['ticket']) && $_SESSION['ticket'] == $_COOKIE['ticket']) {
        ...
        $postsObject->getPostPagination($_GET['page']);
      }
  }  else {
