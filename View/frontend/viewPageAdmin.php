      ...
      <div style="margin-top: 10%;" class="container col-md-12">
          <div class="row ">
            <div class="col-md-2 col-sm-12 text-center mx-auto animated" data-aos="zoom-in">
              ...
              <h5 class="text-center"> <a class="text-decoration-none text-reset" href="index.php?action=pageWriteChapiter"> Ecrire un chapitre </a> </h5>
            </div>
            <div class="col-md-2 col-sm-12 text-center mx-auto" data-aos="zoom-in">
              ...
              <h5 class="text-center"> <a class="text-decoration-none text-reset" href="index.php?action=editPagePosts"> Gestion des chapitres </a> </h5>
            </div>
          <div class="col-md-2 col-sm-12 text-center mx-auto" data-aos="zoom-in">
            ...
            <h5 class="text-center"> <a class="text-decoration-none text-reset" href="index.php?action=alertedcomments"> Commentaires signalées </a> </h5>
          </div>
          <div class="col-md-2 col-sm-12 text-center mx-auto" data-aos="zoom-in">
            ...
            <h5 class="text-center"> <a class="text-decoration-none text-reset" href="index.php?action=pageEditUser"> Gestion des utilisateurs </a> </h5>
          </div>
        </div>
      </div>
</div>
