<nav  class="navbar navbar-expand-lg navbar-light bg-dark">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item"><a class="nav-link text-white" href="index.php?action=pagination&amp;page=1">Tous les chapitres</a></li>
		...
		<ul style="cursor: pointer;" class="navbar-nav" data-aos="fade-left">
			<li class="nav-item dropleft">
				<a class="nav-link dropdown-toggle text-white" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					...
					<span><?php if(isset($_SESSION['goodLogin'])) {echo $_SESSION['goodLogin'];} ?></span>
				</a>
				<div  class="dropdown-menu" aria-labelledby="navbarDropdown">
					<a class="dropdown-item" href="index.php?action=connexion">Se connecter</a>
					<?php if(isset($_SESSION['ticket']) && isset($_COOKIE['ticket']) && $_SESSION['ticket'] == $_COOKIE['ticket'])
          { ?>
